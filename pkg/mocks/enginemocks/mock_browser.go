...
import (
	...
	v1beta1 "github.com/tak-sh/tak/generated/go/api/script/v1beta1"
)
...
func (_m *Browser) Content(ctx context.Context, selector string) ([]*v1beta1.HTMLNodeTemplateData, error) {
	...
	var r0 []*v1beta1.HTMLNodeTemplateData
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]*v1beta1.HTMLNodeTemplateData, error)); ok {
		return rf(ctx, selector)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []*v1beta1.HTMLNodeTemplateData); ok {
		r0 = rf(ctx, selector)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v1beta1.HTMLNodeTemplateData)
		}
	}
...
func (_c *Browser_Content_Call) Return(_a0 []*v1beta1.HTMLNodeTemplateData, _a1 error) *Browser_Content_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Browser_Content_Call) RunAndReturn(run func(context.Context, string) ([]*v1beta1.HTMLNodeTemplateData, error)) *Browser_Content_Call {
	_c.Call.Return(run)
	return _c
}
